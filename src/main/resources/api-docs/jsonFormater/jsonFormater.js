function JsonFormater(opt) {
    this.options = $.extend({
        ...
        singleTab: "  ",
        quoteKeys: true,
        imgCollapsed: "jsonFormater/images/Collapsed.gif",
        imgExpanded: "jsonFormater/images/Expanded.gif",
        isCollapsible: true
    }, opt || {});
...
function getWebPath(){
    ...
    var appPos = pathName.indexOf("/");
    var webPath = wwwPath.substring(0, pos) + "/" + pathName.substring(0, appPos);
    //console.log(webPath);
    return webPath;
}
